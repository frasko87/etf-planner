// app/learn/page.js
// Fix: Footer was missing Privacy, Terms, @etfplan and Start free links.
// This is the full file with the corrected footer — everything else is unchanged.
...
const PLATFORMS = [
  { name:"Robinhood",           logo:"🟢", color:"#00c805", bg:"rgba(0,200,5,0.06)",    border:"rgba(0,200,5,0.2)",    minInvestment:"$1",  fees:"Commission-free",             best:"Best for beginners",        pros:["No account minimum","Commission-free trades","Fractional shares","Clean mobile app"],       cons:["Limited research tools","No retirement accounts on basic plan"],           url:"https://robinhood.com" },
  { name:"Interactive Brokers", logo:"🔵", color:"#0066cc", bg:"rgba(0,102,204,0.06)",  border:"rgba(0,102,204,0.2)",  minInvestment:"$0",  fees:"From $0",                     best:"Best for serious investors", pros:["Access to global markets","Advanced tools","Low margin rates","IBKR Lite is free"],        cons:["Interface can be complex for beginners","Better suited for active traders"],   url:"https://www.interactivebrokers.com" },
  { name:"eToro",               logo:"🟤", color:"#2196a0", bg:"rgba(33,150,160,0.06)", border:"rgba(33,150,160,0.2)", minInvestment:"$10", fees:"Commission-free stocks & ETFs",best:"Best for social investing",  pros:["Copy top investors automatically","Social trading features","Fractional ETFs","Easy to use"], cons:["Withdrawal fee ($5)","Spread on some assets"],                              url:"https://www.etoro.com" },
  { name:"Vanguard",            logo:"🔴", color:"#8b0000", bg:"rgba(139,0,0,0.06)",   border:"rgba(139,0,0,0.2)",   minInvestment:"$1",  fees:"Commission-free Vanguard ETFs",best:"Best for long-term investors",pros:["Lowest expense ratios in the industry","Owned by its investors","VTI, VOO, SCHD direct","Trusted for 50+ years"],cons:["Older interface","Less suited for active trading"],url:"https://investor.vanguard.com" },
];
...
const PAIN_POINTS = [
  { icon:"🧭", q:"\"I don't know where to start\"",              a:"That's exactly why ETFs exist. Instead of picking individual stocks (which is genuinely hard), you buy a fund that holds hundreds of them at once. One purchase, instant diversification. ETF.PLAN tells you exactly which ones to buy and how much each month." },
  { icon:"⏰", q:"\"I don't have time to manage investments\"",  a:"ETFs are the ultimate set-and-forget investment. You buy once a month, hold. No daily monitoring, no earnings calls to track, no panic selling required. Our weekly scoring engine does the analysis — you just follow the plan." },
  { icon:"💰", q:"I want to save money while I earn",            a:"A savings account pays you 4-5% annually if you're lucky. The S&P 500 has returned an average of 10-13% per year over the last decade — after inflation. $100/month invested for 10 years at 12% CAGR becomes over $23,000. A savings account gets you $14,000. The math is clear." },
];
    ...
    <div style={{ minHeight:"100vh", background:"var(--bg)", color:"var(--text)" }}>
      ...
      <div style={{ maxWidth:860, margin:"0 auto", padding:"0 24px 80px" }}>
        ...
        <section style={{ marginBottom:72 }}>
          <h2 style={{ fontFamily:"DM Sans", fontWeight:700, fontSize:"clamp(26px,4vw,40px)", color:"var(--text)", letterSpacing:"-0.5px", marginBottom:20 }}>So, what exactly is an ETF?</h2>
        ...
        {/* Pain points */}
        <section style={{ marginBottom:72 }}>
          <h2 style={{ fontFamily:"DM Sans", fontWeight:700, fontSize:"clamp(26px,4vw,40px)", color:"var(--text)", letterSpacing:"-0.5px", marginBottom:12 }}>Sound familiar?</h2>
          <p style={{ fontFamily:"DM Sans", fontSize:17, color:"var(--muted)", lineHeight:1.8, marginBottom:36 }}>These are the most common reasons people delay investing. Here's the truth about each one.</p>
        ...
        <section style={{ marginBottom:72, background:"var(--text)", borderRadius:20, padding:"48px 40px" }}>
          <h2 style={{ fontFamily:"DM Sans", fontWeight:700, fontSize:"clamp(24px,4vw,36px)", color:"white", letterSpacing:"-0.5px", marginBottom:16 }}>$100/month: ETFs vs Savings Account</h2>
          <p style={{ fontFamily:"DM Sans", fontSize:15, color:"rgba(255,255,255,0.6)", marginBottom:36, lineHeight:1.7 }}>Here's what happens to your money over time — same amount, very different outcomes.</p>
          ...
          <p style={{ fontFamily:"DM Mono", fontSize:11, color:"rgba(255,255,255,0.3)", marginTop:16 }}>Based on historical averages. Past performance does not guarantee future results.</p>
        </section>

        {/* Top ETFs */}
        <section style={{ marginBottom:72 }}>
          <h2 style={{ fontFamily:"DM Sans", fontWeight:700, fontSize:"clamp(26px,4vw,40px)", color:"var(--text)", letterSpacing:"-0.5px", marginBottom:12 }}>The ETFs we track and why they matter</h2>
          <p style={{ fontFamily:"DM Sans", fontSize:17, color:"var(--muted)", lineHeight:1.8, marginBottom:36 }}>These are the most widely held, most trusted ETFs in the world. Each one has been vetted by millions of investors and financial institutions.</p>
            ...
            {TOP_ETFS.map(etf => (
              <div key={etf.ticker} style={{ background:"white", border:`1.5px solid ${etf.color}33`, borderRadius:14, padding:"20px 24px", boxShadow:"var(--shadow)", display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:16 }}>
                ...
                <div style={{ display:"flex", gap:20 }}>
                  {[{l:"10Y CAGR",v:etf.cagr,c:"var(--green)"},{l:"Expense",v:etf.expense,c:"var(--text)"},{l:"Risk",v:etf.risk,c:etf.risk==="Low"?"var(--green)":"var(--gold)"}].map(s=>(
        ...
        {/* How ETFs work */}
        <section style={{ marginBottom:72 }}>
          <h2 style={{ fontFamily:"DM Sans", fontWeight:700, fontSize:"clamp(26px,4vw,40px)", color:"var(--text)", letterSpacing:"-0.5px", marginBottom:12 }}>How ETF investing actually works</h2>
          <p style={{ fontFamily:"DM Sans", fontSize:17, color:"var(--muted)", lineHeight:1.8, marginBottom:36 }}>It's simpler than you think. Here's the full flow from zero to investor.</p>
        ...
        {/* Platforms */}
        <section style={{ marginBottom:72 }}>
          <h2 style={{ fontFamily:"DM Sans", fontWeight:700, fontSize:"clamp(26px,4vw,40px)", color:"var(--text)", letterSpacing:"-0.5px", marginBottom:12 }}>Where to buy ETFs</h2>
          <p style={{ fontFamily:"DM Sans", fontSize:17, color:"var(--muted)", lineHeight:1.8, marginBottom:36 }}>These are the platforms we recommend. All are regulated, trusted and offer commission-free ETF trading.</p>
              ...
              <div key={p.name} style={{ background:"white", border:`1.5px solid ${p.border}`, borderRadius:16, padding:24, boxShadow:"var(--shadow)" }}>
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:14 }}>
                  <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                    <div style={{ width:44, height:44, borderRadius:12, background:p.bg, border:`1px solid ${p.border}`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:22 }}>{p.logo}</div>
                    <div>
                  ...
                  <a href={p.url} target="_blank" rel="noreferrer" style={{ fontFamily:"DM Mono", fontSize:10, color:"var(--muted2)", padding:"5px 10px", border:"1px solid var(--border)", borderRadius:6 }}>Visit ↗</a>
                </div>
                <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10, marginBottom:16 }}>
                  {[{l:"Min. Investment",v:p.minInvestment},{l:"Trading Fees",v:p.fees}].map(s=>(
        ...
        {/* FAQ */}
        <section style={{ marginBottom:72 }}>
          <h2 style={{ fontFamily:"DM Sans", fontWeight:700, fontSize:"clamp(26px,4vw,40px)", color:"var(--text)", letterSpacing:"-0.5px", marginBottom:36 }}>Frequently asked questions</h2>
          <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
            {FAQS.map(faq=>(
        ...
        <section style={{ background:"var(--text)", borderRadius:20, padding:"56px 40px", textAlign:"center" }}>
          <h2 style={{ fontFamily:"DM Sans", fontWeight:700, fontSize:"clamp(28px,5vw,44px)", color:"white", marginBottom:16, letterSpacing:"-0.5px" }}>Ready to start your first plan?</h2>
      ...
      {/* ── FOOTER — FIXED: now includes Privacy, Terms, @etfplan, Start free */}
      <footer style={{ borderTop:"1px solid var(--border)", padding:"24px 40px", display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:12 }}>
        ...
        <div style={{ display:"flex", gap:20, flexWrap:"wrap", alignItems:"center" }}>
          ...
          {/* FIXED: Privacy and Terms now present */}
          ...
          {/* FIXED: Start free CTA now present */}
